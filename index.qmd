...
In @eq-rasch, $X$ denotes a response, persons are indexed by $v$, items by $i$, and $\theta$ and $\beta$ are person and item parameters, respectively. To compute the Rasch model response residuals $Z_{vi}$, we use:
