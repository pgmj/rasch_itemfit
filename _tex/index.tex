...
(Christensen et al., 2017). Regarding residual correlations and critical
values, the \texttt{easyRasch} package also contains a function to use
bootstrapping (\texttt{RIgetResidCor()}), similar to the
