...
What does this look like with a small sample (Figure~\ref{fig-loadloc2})
and what is the item fit in the same small sample
(Table~\ref{tbl-itemfit2} and Figure~\ref{fig-getfit2})?

\phantomsection\label{cell-fig-loadloc2}
\begin{figure}[H]

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-loadloc2-1.pdf}}

}

\caption{\label{fig-loadloc2}}
...
misfit & no misfit & -0.08 \\
V11 & 0.982 & {[}0.816, 1.233{]} & 1.027 & {[}0.726, 1.268{]} & no
misfit & no misfit & -1.24 \\
V12 & 1.156 & {[}0.831, 1.165{]} & 1.342 & {[}0.589, 2.434{]} & no
misfit & no misfit & 1.43 \\
V13 & 1.055 & {[}0.883, 1.191{]} & 1.379 & {[}0.705, 1.736{]} & no
misfit & no misfit & -2.01 \\
V14 & 0.981 & {[}0.804, 1.174{]} & 1.058 & {[}0.737, 1.398{]} & no
misfit & no misfit & 0.45 \\
V15 & 0.948 & {[}0.759, 1.25{]} & 0.887 & {[}0.591, 2.128{]} & no misfit
& no misfit & 0.23 \\
V16 & 0.864 & {[}0.799, 1.217{]} & 0.875 & {[}0.622, 2.079{]} & no
misfit & no misfit & 1.88 \\
V17 & 0.967 & {[}0.774, 1.215{]} & 0.791 & {[}0.63, 3.558{]} & no misfit
& no misfit & 2.06 \\
V18 & 1.143 & {[}0.771, 1.261{]} & 1.172 & {[}0.664, 1.538{]} & no
misfit & no misfit & -1.09 \\
V19 & 0.887 & {[}0.84, 1.171{]} & 0.845 & {[}0.714, 1.432{]} & no misfit
& no misfit & 0.23 \\
V20 & 0.995 & {[}0.867, 1.194{]} & 0.925 & {[}0.774, 1.334{]} & no
misfit & no misfit & -1.24 \\
...
\phantomsection\label{cell-fig-getfit2}
\begin{figure}[H]

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-getfit2-1.pdf}}

}

\caption{\label{fig-getfit2}}
