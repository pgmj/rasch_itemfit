...
simulation studies evaluating the LRT has however not found it to be
sensitive to detect multidimensionality (Debelak 2019).
...
which is how the misfitting items were generate in this study. While no
...
Item fit and item-restscore is recommended to be used in parallel, while
...
contains a function to use bootstrapping, similarly to the
\texttt{RIgetfit()} function, to determine the appropriate cutoff. This
is described briefly in a blog post (Johansson 2024b) and a simulation
